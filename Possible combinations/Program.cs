...
namespace Possible_combinations
{
    class Program
    {
        ...
        {
            FindCombinations("abcd");
            Console.Read();
        }

        public static void FindCombinations(string theString)
        {
            Console.WriteLine(theString);
            RecursiveScrambler(0, theString);
        }

        public static void RecursiveScrambler(int start, string alphabet)
        {
        ...
        public static char[] ToArray(string alphabet)
        {
        ...
        public static string ArrToString(char[] alphabet)
        {
            string newString = "";
            for (int i = 0; i < alphabet.Length; i++)
            {
